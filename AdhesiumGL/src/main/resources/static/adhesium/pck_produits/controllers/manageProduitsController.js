...
var manageProduitsController = angular.module('manageProduitsController',[]);

manageProduitsController.controller('manageProduitsController', ['$scope','$rootScope','headerService','Upload', '$timeout','$http', 
	function($scope,$rootScope,headerService,Upload, $timeout,$http){
	/*Menu SideBar*/
	$rootScope.SideBarshow = 5;
	$rootScope.SubSideBarshow = 55;
	/*Begin Controller*/
	$scope.motCle = "";
	$scope.client = {};
